...
import heroImageSmallScreen from "@/assets/hero_session.jpg";
import heroImage from "@/assets/hero_session_desktop.jpg";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={isMobile ? heroImageSmallScreen : heroImage}
